...
\section{课题主要研究内容}
1993年，Gordon、Salmond和Smith提出Bootstrap粒子滤波，在不依赖线性化或高斯假设的条件下实现了递推贝叶斯状态估计\cite{gordon1993novel}。1994年，Kong和Liu围绕序贯重要性采样框架讨论了权重退化、粒子耗尽及有效粒子数等问题\cite{kong1994sequential}。1996年，Kitagawa在重采样步骤中引入分层采样思想\cite{kitagawa1996monte}。  
